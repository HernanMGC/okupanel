...
define('OKUPANEL_TEXTDOMAIN', 'okupanel');
...
function okupanel_em_event_output($event_string, $event, $format, $target) {
	$event_string = str_replace(":",'\:',$event_string);
	return $event_string;
}
add_filter('em_event_output', 'okupanel_em_event_output', 10, 4);
